...
void MD5::decode(uint4 output[], const uint1 input[], u32 len)
{
...
// a multiple of 4.
void MD5::encode(uint1 output[], const uint4 input[], u32 len)
{
