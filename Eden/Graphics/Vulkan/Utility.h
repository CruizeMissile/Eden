...
namespace edn
{
	namespace Graphics
	{
		namespace Vk
		{
			...
			inline bool check_device_extention_support(VkPhysicalDevice device)
			{
			...
			inline QueueFamilyIndices find_queue_families(VkPhysicalDevice device, VkSurfaceKHR surface)
			{
